...
filterNameInput.addEventListener('keyup', function() {
    bulkheadObjectCookies(filterNameInput.value);
});
...
function bulkheadObjectCookies(src) {
    let cookies = createCookiesObj();

    listTable.innerHTML = '';
    Object.keys(cookies).forEach((name) => {
        if(isMatching(cookies[name], src) || isMatching(name, src)) {
            writeCookies(name, cookies[name]);
        }
    })
}
